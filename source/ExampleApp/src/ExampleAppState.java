...
public class ExampleAppState implements SwirldState {
	...
	public synchronized FastCopyable copy() {
		ExampleAppState copy = new ExampleAppState();
		copy.copyFrom(this);
		return copy;
	}
	...
	public synchronized void copyFrom(SwirldState old) {
		strings = Collections.synchronizedList(
				new ArrayList<String>(((ExampleAppState) old).strings));
		addressBook = ((ExampleAppState) old).addressBook.copy();
	}
